...
async function getShoesDataMen() {
    try {
      const shoesData = await Shoes.find();
      const menShoes = shoesData.filter(item => item.shoe_sex === "men");
      return menShoes;
    } catch (error) {
...
module.exports = {passOnShoesMen, getShoesDataMen}
