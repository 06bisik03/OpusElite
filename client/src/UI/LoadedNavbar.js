...
const LoadedNavbar = ({ topTrendingMen, topTrendingWomen, itemAmount }) => {
  return (
      ...
      <div className={styles.linksContainer}>
              ...
              <div className={styles.column}>
                ...
                <div className={styles.rightColumn}>
                  <a
                    ...
                    href={`/product/${topTrendingMen[2]._id}`}>
                    <img alt="_"src={topTrendingMen[2].scent_image1} />
                  </a>
                  <div>
                    ALL TIME BESTSELLER:
                    <br />
                    {topTrendingMen[2].scent_name}
                  </div>
                </div>
              </div>
              <NavbarItems items={topTrendingMen} />
            </div>
          </div>
        </div>
        <div className={styles.dropdown}>
          ...
          <div className={styles.dropdownContent}>
            <div className={styles.row}>
              <div className={styles.column}>
                ...
                <div className={styles.rightColumn}>
                  <a
                    href={`/product/${topTrendingWomen[2]._id}`}
                    className={styles.imgNav}>
                    <img alt="_"src={topTrendingWomen[2].scent_image1} />
                  </a>
                  <div>
                    Our All-Time Bestseller:
                    <br />
                    {topTrendingWomen[2].scent_name}
                  </div>
                </div>
              </div>
              <NavbarItems items={topTrendingWomen} />
            </div>
          </div>
        </div>
        <div className={styles.linkContainer}>
          <Link className={styles.links} to="/opuselite">
            Our Brand
          </Link>
        </div>
        <div className={styles.linkContainer}>
        ...
        <div className={styles.linkContainer}>
          <Link className={styles.links} to="/cart">
            <button data-quantity={itemAmount || 0} className={styles.btnCart}>
              <svg
