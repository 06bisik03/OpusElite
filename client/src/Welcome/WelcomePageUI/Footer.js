    ...
    <div className={styles.footerContainer}>
      <div className={styles.newsLetter}>
        ...
        <div className={styles.convince}>
          Step into OpusElite's world of style. Our newsletter delivers curated
          elegance, personalized for you. Elevate your fashion journey with
          every click.
        </div>
      ...
      <div className={styles.socials}>
        <div>
          <div className={styles.card}>
            ...
            <a
              ...
              <svg
                viewBox="0 0 16 16"
                className={`${styles.socialSvg} ${styles.whatsappSvg}`}>
                {" "}
        ...
        <div>© 2023 OpusElite - Rights not Reserved</div>
      </div>
    </div>
  );
};
